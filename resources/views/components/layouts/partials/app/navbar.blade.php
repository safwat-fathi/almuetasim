...
<nav class="navbar shadow-lg sticky top-0 z-50" style="background-color: #f8fafc;" role="navigation" aria-label="التنقل الرئيسي">
    ...
    <div class="navbar-end gap-2">
        ...
        <!-- Wishlist Dropdown -->
        <div class="dropdown dropdown-end" id="wishlist-dropdown-container" role="region" aria-label="قائمة المفضلة">
            <div tabindex="0" role="button" class="btn btn-ghost btn-circle" id="wishlist-btn" aria-label="قائمة المفضلة ({{ $wishlistCount }} عناصر)">
                <div class="indicator">
            ...
            <div tabindex="0" class="card card-compact dropdown-content bg-base-100 z-[1] mt-3 w-80 shadow-xl" role="dialog" aria-label="محتوى قائمة المفضلة">
                <div class="card-body">
        ...
        <div class="dropdown dropdown-end" role="region" aria-label="سلة التسوق">
            <div tabindex="0" role="button" class="btn btn-ghost btn-circle" aria-label="سلة التسوق (0 عناصر)">
                <div class="indicator">
                    <i data-lucide="shopping-cart" aria-hidden="true"></i>
                    <span class="badge badge-sm indicator-item text-white" id="cart-count"
                        style="background-color: #2d3b61;" aria-label="0 عناصر في السلة">0</span>
                </div>
            </div>
            <div tabindex="0" class="card card-compact dropdown-content bg-base-100 z-[1] mt-3 w-80 shadow-xl" role="dialog" aria-label="محتوى سلة التسوق">
                <div class="card-body">
                    <h3 class="text-lg font-bold" id="cart-title">عناصر السلة</h3>
                    <div id="cart-items" class="space-y-2" role="list" aria-labelledby="cart-title">
                        <p class="text-base-content/70">سلة التسوق فارغة</p>
                    </div>
                    <div class="card-actions">
                        <button class="btn btn-block text-white"
                            style="background-color: #2d3b61; border-color: #2d3b61;" aria-label="عرض سلة التسوق">
