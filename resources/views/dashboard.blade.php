                ...
                <td>
                    <div class="dropdown dropdown-end">
                        ...
                        <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                            <li><a onclick="editProduct(${product.id})"><i data-lucide="edit" class="w-4 h-4"></i> Edit</a></li>
                            <li><a onclick="duplicateProduct(${product.id})"><i data-lucide="copy" class="w-4 h-4"></i> Duplicate</a></li>
                            <li><a onclick="deleteProduct(${product.id})" class="text-error"><i data-lucide="trash-2" class="w-4 h-4"></i> Delete</a></li>
                        </ul>
                    </div>
                </td>
            `;
