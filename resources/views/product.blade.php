			...
			<div class="border-t pt-6">
				...
				<ul class="space-y-2">
					<li class="flex items-center gap-2">
						...
						<span class="text-sm">خامات عالية الجودة</span>
					</li>
					@if($product->warranty_months > 0)
						<li class="flex items-center gap-2">
							<i data-lucide="check-circle" class="w-4 h-4 text-success"></i>
							<span class="text-sm">{{ $product->warranty_months }} أشهر الضمان</span>
						</li>
					@endif
					<li class="flex items-center gap-2">
						<i data-lucide="check-circle" class="w-4 h-4 text-success"></i>
						<span class="text-sm">سهل الاستخدام</span>
					</li>
					<li class="flex items-center gap-2">
						<i data-lucide="check-circle" class="w-4 h-4 text-success"></i>
						<span class="text-sm">إهتمادي</span>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
			...
			<div class="lg:col-span-2 space-y-6">
				...
				<div class="border-b pb-4">
					...
					<p class="text-sm text-base-content/70">This {{ $product->title }} exceeded my expectations. The build
						quality is excellent and it works perfectly. Highly recommend!</p>
				</div>
				...
				<div class="border-b pb-4">
					...
					<p class="text-sm text-base-content/70">Perfect {{ $product->category->name }}. Works exactly as described.
						The price is very reasonable for the quality you get.</p>
				</div>
				...
				<div class="border-b pb-4">
					...
					<p class="text-sm text-base-content/70">The quality is excellent and it arrived quickly. Will definitely buy
						from this store again.</p>
				</div>
